...
import { View, Text, StyleSheet, Image, ScrollView, Picker, TextInput, Button } from 'react-native';  
  ...
  return (  
    <ScrollView style={styles.container}>  
      ...
      <TextInput  
        ...
        onChangeText={(text) => setTicketQuantity(Math.max(0, Number(text)))}  
      />  
      ...
      <Button title="Confirmar Compra" onPress={() => alert(`Has comprado ${ticketQuantity} entradas para ${selectedDate} a las ${selectedShowtime}. Total: $${totalPrice.toFixed(2)}`)} />  
    </ScrollView>  
  );  
};  
